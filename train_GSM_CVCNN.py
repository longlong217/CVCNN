...
from CV_CVCNN_Model import *#导入了名为model_complexcnn_onlycnn的模块
...
def main():
    conf = Config()
    writer = SummaryWriter("logs_train_GSM_CVCNN_rand_lunwen" + str(conf.rand_num))#这个路径将用于存储TensorBoard日志文件
